...
const page = () => {
  return (
    <div className="min-h-screen bg-cover bg-fixed bg-[url(/assets/battle-background-2.jpg)] grid xl:grid-cols-[1fr_1fr_1fr] lg:grid-cols-[1fr_1fr_1fr] max-[770px]:grid-cols-[1fr] xl:p-20 lg:p-20 p-0 w-full sm: grid-cols-1">
      ...
      <div></div>
      <div className="max-[1024px]:flex max-[1024px]:flex-col max-[1024px]:place-self-center w-[clamp(100px,80vw,400px)] min-[1024px]:min-h-screen p-10 bg-[url(/assets/11468999.png)] max-[1024px]:order-2 bg-size-[100%_100%] flex flex-col px-15 sm:px-20 lg:px-30 md:px-30 py-35">
      </div>
